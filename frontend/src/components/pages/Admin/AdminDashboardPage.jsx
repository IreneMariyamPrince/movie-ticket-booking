...
import DashboardInfoCards from '../../organisms/Admin/DashboardInfoCards';
import DashboardInfoCharts from '../../organisms/Admin/DashboardInfoCharts';
const AdminDashboardPage = () => {
  const [counts, setCounts] = useState({
    regionActiveUsers: 0,
    employerActiveUsers: 0,
    candidateActiveUsers: 0,
  });
...
//     try {
//       const data = await dashboardApi.dashboardData();
//       setRegionChartData(data.chartData.previousWeekCountsRegion);
//       setEmployerChartData(data.chartData.previousWeekCountsEmployer);
//       setCandidateChartData(data.chartData.previousWeekCountsCandidate);
//       setFromDate(data.chartData.fromDate);
//       setToDate(data.chartData.toDate);
//       setCounts(data.count);
//       setPercentageDifference(data.percentageDifference);
//     } catch (error) {
...
//   }, []);
  ...
  return (
    <>
      <DashboardInfoCards counts={counts} percentageDifference={percentageDifference} />

      <DashboardInfoCharts
        regionChartData={regionChartData}
        employerChartData={employerChartData}
