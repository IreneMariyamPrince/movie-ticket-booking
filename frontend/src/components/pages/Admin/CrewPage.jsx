...
import { CrewRoleFilterStatus, DateFilterStatus } from '../../constants/FilterData';
...
const CrewPage = () => {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const response = await crewApi.crewList(page + 1, rowsPerPage, searchQuery, filterDate, filterRole);
      if (response) {
  ...
  const handleDeleteConfirmation = async id => {
    try {
      ...
      await fetchData();
      toast.success('Crew member deleted successfully', { autoClose: 2000 });
    } catch (error) {
          ...
          <div className='card my-4 mb-0'>
            <div className='card-header p-0 position-relative mt-n4 mx-3 z-index-2'>
              <div className='bg-gradient-primary shadow-primary border-radius-lg pt-4 px-3 pb-3 d-flex align-items-center justify-content-between'>
                <h6 className='text-white text-capitalize ps-3 mb-0'>Crew List</h6>
            ...
            <div className='d-flex align-items-center justify-content-between px-5'>
              ...
              <FilterBox filterArray={CrewRoleFilterStatus} label='Role' onChange={handleFilterRole} />
                  ...
                  <table className='table align-items-center mb-0'>
                    ...
                    <tbody>
                      {crewData?.map((crew, index) => {
                        const { _id, Name, Image, Role } = crew;
                          ...
                          <tr key={index}>
                            ...
                            <td className='align-middle text-center'>
                              <div className='d-flex align-items-center justify-content-center'>
                                <ConfirmationDialog
                                  title='Are you sure you want to delete this crew member permanently?'
                                  icon='warning'
